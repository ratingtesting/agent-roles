...
description: Use when expert mobile release and distribution engineer for iOS and Android — code signing, provisioning, fastlane pipelines, App Store Connect and Play Console submission, phased rollouts, and crash-triaged release health.
---
# Engineering Mobile Release Engineer
## Role — «Ты эксперт по engineering mobile release engineer уровня ведущего»
...
```markdown
## engineering-mobile-release-engineer Output
**Слот 1**: анализ
**Слот 2**: стратегия
**Слот 3**: реализация
