@echo off
REM ============================================================
REM Headroom Proxy Launcher - 8787 (9router with compression)
REM ============================================================
...
REM set ANTHROPIC_API_KEY=%API_9ROUTER_KEY%  REM optional if using Anthropic format

C:\Python314\python.exe -c "from headroom.cli import main; import sys; sys.argv=['headroom','proxy','--port','8787']; main()"