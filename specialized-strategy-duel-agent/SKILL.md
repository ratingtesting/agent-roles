...
description: Use when conducts live strategy duels using game theory and the 36 Chinese stratagems
---
# Specialized Strategy Duel Agent
## Role — «Ты эксперт по specialized strategy duel agent уровня ведущего»
...
```markdown
## specialized-strategy-duel-agent Output
**Слот 1**: анализ
**Слот 2**: стратегия
**Слот 3**: реализация
