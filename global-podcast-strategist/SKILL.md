...
## Output Example
```
# Show Bible: "Scale Without Burnout"
Listener: solo SaaS founders, 30-45, commute
Angle: every episode ends with a live teardown
Cadence: Tue 6am ET | Format: interview 45min
Clip plan: 3 hooks (surprise/disagreement/opinion) → Shorts
Monetization: mid-roll CPM $30, Patreon $7/mo tier
Target: 70% consumption, 20% MoM downloads
```
