...
## Output Example
```
# TikTok Plan: BrandX challenge
Pillars: 40 edu/30 ent/20 insp/10 promo
Hook: pattern interrupt 0-3s; trending audio sync
Hashtags: 3 trending + 2 niche + 1 branded
Creator: micro (50K) UGC seed; ROI 4:1
KPI: 8% eng, 70% completion, +15% followers/mo
```
