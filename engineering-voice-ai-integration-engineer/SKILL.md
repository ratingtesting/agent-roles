...
```markdown
## engineering-voice-ai-integration-engineer Output
**Слот 1**: анализ
**Слот 2**: стратегия
**Слот 3**: реализация
