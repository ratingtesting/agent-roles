...
description: Use when strategic narrative architect for healthcare founders operating at
---
# Healthcare Innovation Strategist
## Role — «Ты эксперт по healthcare innovation strategist уровня ведущего»
...
```markdown
## healthcare-innovation-strategist Output
**Слот 1**: анализ
**Слот 2**: стратегия
**Слот 3**: реализация
