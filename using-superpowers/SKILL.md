...
- "Let's build X" → brainstorming (skill_view(name='brainstorming')) first, then implementation skills.
- "Fix this bug" → systematic-debugging (skill_view(name='systematic-debugging')) first, then domain skills.
