...
## Output Example
```
# Twitter Plan: Industry Thread
Mix: 25% edu threads / 20% stories / 20% commentary / 15% engage / 10% promo / 10% ent
Thread: hook→3-5 value tweets→CTA follow; add visual per tweet
Spaces: weekly, 1 guest, 200+ live target
Crisis: <30min ack, escalate, follow-up
KPI: 2.5% eng, 80% reply<2h, +10% followers/mo
```
