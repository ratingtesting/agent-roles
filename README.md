...
|-------|-------|-----------|-------------|
| 🏔️ | [3d-scene-developer](3d-scene-developer/SKILL.md) | 3D Scene Developer | Use when нужна 3D-визуализация ГИС-данных |
| 🔐 | [agentic-identity-trust](agentic-identity-trust/SKILL.md) | Agentic Identity Trust | Use when нужна схема идентичности и доверия агентов |
...
| 🤖 | [ai-developer-experience-auditor](ai-developer-experience-auditor/SKILL.md) | Ai Developer Experience Auditor | Use when аудит AI-agent compatibility / AGENTS.md / llms.txt / AI_DEVELOPMENT_RULES в репозитории (machine-enforced file checks) |
| 🤖 | [ai-engineer](ai-engineer/SKILL.md) | Ai Engineer | Use when building ML models into production |
| 🔎 | [ai-generated-code-security-auditor](ai-generated-code-security-auditor/SKILL.md) | Ai Generated Code Security Auditor | Use when аудит безопасности кода от ИИ-ассистентов |
| 🔌 | [api-platform-engineer](api-platform-engineer/SKILL.md) | Api Platform Engineer | Use when designing public/partner APIs |
| 🔌 | [api-tester](api-tester/SKILL.md) | Api Tester | Use when тестирование API и интеграций |
| 🔐 | [application-security-engineer](application-security-engineer/SKILL.md) | Application Security Engineer | Use when безопасность кода и SDLC |
...
| 🧩 | [blender-add-on-engineer](blender-add-on-engineer/SKILL.md) | Blender Add On Engineer | Use when аддоны и автоматизация Blender |
| 🛡️ | [blockchain-security-auditor](blockchain-security-auditor/SKILL.md) | Blockchain Security Auditor | Use when аудит смарт-контрактов |
| ☁️ | [cloud-security-architect](cloud-security-architect/SKILL.md) | Cloud Security Architect | Use when безопасность облачной инфраструктуры |
...
| ⚡ | [drupal-performance](drupal-performance/SKILL.md) | Drupal Performance | Use when ускорение Drupal-сайта до Core Web Vitals |
...
| 🏛️ | [flutter-architecture-auditor](flutter-architecture-auditor/SKILL.md) | Flutter Architecture Auditor | Use when аудит Clean Architecture / feature-first / Repository law / boundaries в Flutter-проекте (machine-enforced grep/analyze) |
| 🗄️ | [flutter-database-storage-auditor](flutter-database-storage-auditor/SKILL.md) | Flutter Database Storage Auditor | Use when аудит Drift / local DB / caching / environments / secrets в Flutter (machine-enforced grep/analyze) |
| 🔒 | [flutter-security-production-auditor](flutter-security-production-auditor/SKILL.md) | Flutter Security Production Auditor | Use when аудит security / production-readiness / services-contracts / crash-reporting в Flutter (machine-enforced grep) |
| 🧪 | [flutter-testing-qa-auditor](flutter-testing-qa-auditor/SKILL.md) | Flutter Testing Qa Auditor | Use when аудит тестов / CI/CD / reference tests (Repository, Provider, Auth, Routing, Flags, Drift) в Flutter (machine-enforced flutter test) |
| 🖥️ | [frontend-developer](frontend-developer/SKILL.md) | Frontend Developer | Use when building web frontends |
| 🎵 | [game-audio-engineer](game-audio-engineer/SKILL.md) | Game Audio Engineer | Use when нужна интеграция звука, музыки и голоса в игру |
| 🤖 | [geoai-ml-engineer](geoai-ml-engineer/SKILL.md) | Geoai Ml Engineer | Use when нужны ML-модели по снимкам и геоданным |
| ✅ | [gis-qa-engineer](gis-qa-engineer/SKILL.md) | Gis Qa Engineer | Use when нужна проверка качества геоданных и карт |
| 🌿 | [git-workflow-master](git-workflow-master/SKILL.md) | Git Workflow Master | Use when setting team Git workflow |
| 🎯 | [godot-gameplay-scripter](godot-gameplay-scripter/SKILL.md) | Godot Gameplay Scripter | Use when нужен код геймплея и сигналов в Godot 4 |
| 🌐 | [godot-multiplayer-engineer](godot-multiplayer-engineer/SKILL.md) | Godot Multiplayer Engineer | Use when нужен мультиплеер и синхронизация в Godot |
| 💎 | [godot-shader-developer](godot-shader-developer/SKILL.md) | Godot Shader Developer | Use when нужны шейдеры и визуальные эффекты в Godot |
...
| 📷 | [image-prompt-engineer](image-prompt-engineer/SKILL.md) | Image Prompt Engineer | Use when нужен промпт для фото-генерации: свет, оптика |
| 🏢 | [infrastructure-maintainer](infrastructure-maintainer/SKILL.md) | Infrastructure Maintainer | Use when нужна поддержка инфраструктуры: обновления, бэкапы |
| 🔍 | [investment-researcher](investment-researcher/SKILL.md) | Investment Researcher | Use when нужен разбор инвестиций: оценка, анализ рынка |
| 📡 | [iot-fleet-engineer](iot-fleet-engineer/SKILL.md) | Iot Fleet Engineer | Use when managing device fleets |
| 📋 | [jira-workflow-steward](jira-workflow-steward/SKILL.md) | Jira Workflow Steward | Use when нужна настройка Jira: workflow, статусы |
...
| 🍎 | [macos-spatial-metal-engineer](macos-spatial-metal-engineer/SKILL.md) | Macos Spatial Metal Engineer | Use when нужен Metal/Spatial-код для macOS: GPU, Vision, AR |
...
| 🗡️ | [penetration-tester](penetration-tester/SKILL.md) | Penetration Tester | Use when нужен пентест: уязвимости, эксплуатация, отчёт |
...
| 👤 | [roblox-avatar-creator](roblox-avatar-creator/SKILL.md) | Roblox Avatar Creator | Use when создаются UGC-аватары и аксессуары Roblox |
| 🎪 | [roblox-experience-designer](roblox-experience-designer/SKILL.md) | Roblox Experience Designer | Use when проектируются циклы вовлечённости Roblox |
| 🔧 | [roblox-systems-scripter](roblox-systems-scripter/SKILL.md) | Roblox Systems Scripter | Use when пишется серверная логика и Luau-системы Roblox |
| 🛠️ | [sales-engineer](sales-engineer/SKILL.md) | Sales Engineer | Use when нужна техническая защита сделки (POC, демо) |
| 🔍 | [search-query-analyst](search-query-analyst/SKILL.md) | Search Query Analyst | Use when анализируются поисковые запросы рекламы |
| 🔎 | [search-relevance-engineer](search-relevance-engineer/SKILL.md) | Search Relevance Engineer | Use when tuning search relevance |
| 🔑 | [secrets-credential-hygiene-engineer](secrets-credential-hygiene-engineer/SKILL.md) | Secrets Credential Hygiene Engineer | Use when управляются секреты и доступы в коде |
| 🛡️ | [security-architect](security-architect/SKILL.md) | Security Architect | Use when проектируется модель безопасности системы |
| 💎 | [senior-developer](senior-developer/SKILL.md) | Senior Developer | Use when building premium Laravel |
| 🛡️ | [senior-secops-engineer](senior-secops-engineer/SKILL.md) | Senior Secops Engineer | Use when код проверяется на секреты и уязвимости |
...
| ⛓️ | [solidity-smart-contract-engineer](solidity-smart-contract-engineer/SKILL.md) | Solidity Smart Contract Engineer | Use when разработка и аудит смарт-контрактов Solidity |
| 🔧 | [solution-engineer](solution-engineer/SKILL.md) | Solution Engineer | Use when строятся GIS-прототипы и демо (Esri) |
...
| 🏗️ | [specialized-civil-engineer](specialized-civil-engineer/SKILL.md) | Specialized Civil Engineer | Use when расчёт или проверка конструкции по нормам |
...
| 🏃 | [swarm-runner-engineer](swarm-runner-engineer/SKILL.md) | Swarm Runner Engineer | Use when engineering swarm runner: claim-locks, heartbeats, timeouts, agent launch. |
| 🎭 | [test-automation-engineer](test-automation-engineer/SKILL.md) | Test Automation Engineer | Use when нужна E2E-автоматизация тестов |
| 📋 | [test-results-analyzer](test-results-analyzer/SKILL.md) | Test Results Analyzer | Use when нужен анализ результатов тестов |
| 🎯 | [threat-detection-engineer](threat-detection-engineer/SKILL.md) | Threat Detection Engineer | Use when нужны SIEM-детекты и MITRE |
| 🔭 | [trend-researcher](trend-researcher/SKILL.md) | Trend Researcher | Use when researching market trends |
| 🏛️ | [unity-architect](unity-architect/SKILL.md) | Unity Architect | Use when Unity-код запутан; нужна SO-архитектура. |
| 🛠️ | [unity-editor-tool-developer](unity-editor-tool-developer/SKILL.md) | Unity Editor Tool Developer | Use when рутина в Unity-редакторе; нужны тулзы. |
| 🔗 | [unity-multiplayer-engineer](unity-multiplayer-engineer/SKILL.md) | Unity Multiplayer Engineer | Use when Unity-мультиплер, сетевая синхронизация. |
| ✨ | [unity-shader-graph-artist](unity-shader-graph-artist/SKILL.md) | Unity Shader Graph Artist | Use when нужны шейдеры/эффекты Unity; URP/HDRP. |
| 🌐 | [unreal-multiplayer-architect](unreal-multiplayer-architect/SKILL.md) | Unreal Multiplayer Architect | Use when UE5-мультиплеер; репликация, RPC-валидация. |
| ⚙️ | [unreal-systems-engineer](unreal-systems-engineer/SKILL.md) | Unreal Systems Engineer | Use when UE5-системы (GAS, C++/BP, Nanite/Lumen, перфоманс). |
| 🎨 | [unreal-technical-artist](unreal-technical-artist/SKILL.md) | Unreal Technical Artist | Use when UE5-визуал: материалы, Niagara, PCG, LOD. |
...
| 🏛️ | [uswds-developer](uswds-developer/SKILL.md) | Uswds Developer | Use when фронтенд для госсайтов США на USWDS |
| 📐 | [ux-architect](ux-architect/SKILL.md) | Ux Architect | Use when нужен CSS-фундамент, layout, UX-структура. |
| 🔬 | [ux-researcher](ux-researcher/SKILL.md) | Ux Researcher | Use when нужны исследования UX, персона, тесты. |
...
| 🎙️ | [voice-ai-integration-engineer](voice-ai-integration-engineer/SKILL.md) | Voice Ai Integration Engineer | Use when пайплайн речи: транскрипция аудио |
| 🌐 | [web-gis-developer](web-gis-developer/SKILL.md) | Web Gis Developer | Use when building interactive web maps |
| 🧩 | [webassembly-engineer](webassembly-engineer/SKILL.md) | Webassembly Engineer | Use when портирование кода в WebAssembly |
...
| ⚡ | [wordpress-performance](wordpress-performance/SKILL.md) | Wordpress Performance | Use when ускорение WordPress-сайта |
...
| 🗺️ | [workflow-architect](workflow-architect/SKILL.md) | Workflow Architect | Use when проектирование воркфлоу, спека путей |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| 🎨 | [brand-guardian](brand-guardian/SKILL.md) | Brand Guardian | Use when бренд, айдентика, тон коммуникации |
| 🎨 | [cartography-designer](cartography-designer/SKILL.md) | Cartography Designer | Use when дизайн карт и стилизация |
...
| 💰 | [economy-designer](economy-designer/SKILL.md) | Economy Designer | Use when нужен расчёт и баланс виртуальной экономики игры |
| 🎮 | [game-designer](game-designer/SKILL.md) | Game Designer | Use when нужен геймдизайн, механики, GDD и баланс |
| 🌈 | [inclusive-visuals-specialist](inclusive-visuals-specialist/SKILL.md) | Inclusive Visuals Specialist | Use when нужны инклюзивные визуалы: доступность, образы |
| 🗺️ | [level-designer](level-designer/SKILL.md) | Level Designer | Use when нужен дизайн уровней: геймплей, темп, баланс |
| 📖 | [narrative-designer](narrative-designer/SKILL.md) | Narrative Designer | Use when нужен нарратив: сюжет, персонажи, выбор |
| 🎭 | [persona-walkthrough-specialist](persona-walkthrough-specialist/SKILL.md) | Persona Walkthrough Specialist | Use when нужен CRO-аудит страницы через симуляцию персоны |
...
| 🎨 | [technical-artist](technical-artist/SKILL.md) | Technical Artist | Use when нужен арт-пайплайн и шейдеры в движке |
| 🎨 | [ui-designer](ui-designer/SKILL.md) | Ui Designer | Use when designing a UI component system |
| 🧱 | [ui-finish-gate-reviewer](ui-finish-gate-reviewer/SKILL.md) | Ui Finish Gate Reviewer | Use when UI перед релизом шаблонный; нужен pass/hold-гейт. |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| ✍️ | [ad-creative-strategist](ad-creative-strategist/SKILL.md) | Ad Creative Strategist | Use when креативы и тексты для платной рекламы |
...
| 📧 | [email-strategist](email-strategist/SKILL.md) | Email Strategist | Use when сегментация и рассылки, доставляемость |
...
| 🧲 | [offer-lead-gen-strategist](offer-lead-gen-strategist/SKILL.md) | Offer Lead Gen Strategist | Use when нужна стратегия оффера и лидогенерации |
| 📋 | [paid-media-auditor](paid-media-auditor/SKILL.md) | Paid Media Auditor | Use when нужен аудит платного трафика: метрики, слив бюджета |
| 📱 | [paid-social-strategist](paid-social-strategist/SKILL.md) | Paid Social Strategist | Use when нужна стратегия платного соц-трафика: Meta, TikTok |
| 🎧 | [podcast-strategist](podcast-strategist/SKILL.md) | Podcast Strategist | Use when launching a podcast in China's market. |
| 💰 | [ppc-campaign-strategist](ppc-campaign-strategist/SKILL.md) | Ppc Campaign Strategist | Use when нужна архитектура платных кампаний PPC |
...
| 📺 | [programmatic-display-buyer](programmatic-display-buyer/SKILL.md) | Programmatic Display Buyer | Use when нужна закупка display/программатик-медиа |
...
| 📱 | [wechat-official-account](wechat-official-account/SKILL.md) | Wechat Official Account | Use when ведение аккаунта WeChat (公众号) |
| 🔥 | [weibo-strategist](weibo-strategist/SKILL.md) | Weibo Strategist | Use when running brand operations on Weibo. |
| 🛰️ | [x-twitter-intelligence-analyst](x-twitter-intelligence-analyst/SKILL.md) | X Twitter Intelligence Analyst | Use when анализ данных X/Twitter для решений |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| ♟️ | [deal-strategist](deal-strategist/SKILL.md) | Deal Strategist | Use when квалификация и стратегия сделок |
| 🔍 | [discovery-coach](discovery-coach/SKILL.md) | Discovery Coach | Use when нужен разбор техники discovery-звонков и вопросов |
...
| 🎯 | [outbound-strategist](outbound-strategist/SKILL.md) | Outbound Strategist | Use when нужен аутрич: письма, последовательности, таргет |
| 📊 | [pipeline-analyst](pipeline-analyst/SKILL.md) | Pipeline Analyst | Use when нужен разбор воронки, прогноз и скоринг сделок CRM |
| 🏹 | [proposal-strategist](proposal-strategist/SKILL.md) | Proposal Strategist | Use when нужна стратегия и нарратив предложения (RFP) |
| 🏋️ | [sales-coach](sales-coach/SKILL.md) | Sales Coach | Use when нужен коучинг sales-репов и разбор воронки |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| 🗺️ | [account-strategist](account-strategist/SKILL.md) | Account Strategist | Use when рост существующих аккаунтов и NRR |
| 🧠 | [behavioral-nudge-engine](behavioral-nudge-engine/SKILL.md) | Behavioral Nudge Engine | Use when поведенческие подсказки в продукте |
...
| 🧭 | [healthcare-innovation-strategist](healthcare-innovation-strategist/SKILL.md) | Healthcare Innovation Strategist | Use when нужен нарратив healthcare: питч, регулятор, аудит |
| 📜 | [narratologist](narratologist/SKILL.md) | Narratologist | Use when нужен анализ повествования: структура, жанр, миф |
...
| 🌍 | [specialized-cultural-intelligence-strategist](specialized-cultural-intelligence-strategist/SKILL.md) | Specialized Cultural Intelligence Strategist | Use when проверка интерфейса на культурную исключённость |
| ⚔️ | [strategy-duel-agent](strategy-duel-agent/SKILL.md) | Strategy Duel Agent | Use when стратегическая дуэль: анализ конфликта |
| 🎓 | [study-abroad-advisor](study-abroad-advisor/SKILL.md) | Study Abroad Advisor | Use when стратегия поступления за рубеж |
...
| 🏛️ | [tax-strategist](tax-strategist/SKILL.md) | Tax Strategist | Use when нужна налоговая оптимизация и комплаенс |
| 🧠 | [technical-consultant](technical-consultant/SKILL.md) | Technical Consultant | Use when нужна GIS-стратегия и выбор решений |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| 📒 | [bookkeeper-controller](bookkeeper-controller/SKILL.md) | Bookkeeper Controller | Use when бухгалтерия и закрытие месяца |
...
| 📄 | [document-generator](document-generator/SKILL.md) | Document Generator | Use when генерация PDF/PPTX/DOCX/XLSX кодом |
| 📝 | [executive-summary-generator](executive-summary-generator/SKILL.md) | Executive Summary Generator | Use when нужна краткая сводка для руководителей из отчёта |
| 🔍 | [feedback-synthesizer](feedback-synthesizer/SKILL.md) | Feedback Synthesizer | Use when нужен анализ отзывов пользователей и приоритеты |
| 💰 | [finance-tracker](finance-tracker/SKILL.md) | Finance Tracker | Use when нужен контроль бюджета и денежных потоков компании |
| 📊 | [financial-analyst](financial-analyst/SKILL.md) | Financial Analyst | Use when нужна финмодель, прогноз и оценка сценариев |
| 📈 | [fp-a-analyst](fp-a-analyst/SKILL.md) | Fp A Analyst | Use when нужен бюджет, прогноз и план-факт анализ |
| 📋 | [meeting-notes-specialist](meeting-notes-specialist/SKILL.md) | Meeting Notes Specialist | Use when нужны заметки со встречи: протокол, решения, задачи |
| ⚙️ | [operations-manager](operations-manager/SKILL.md) | Operations Manager | Use when optimizing business operations |
| 🧭 | [product-manager](product-manager/SKILL.md) | Product Manager | Use when нужен менеджер продукта: PRD, роадмап, запуск |
| 🐑 | [project-shepherd](project-shepherd/SKILL.md) | Project Shepherd | Use when нужна координация кросс-функционального проекта |
...
| 🏭 | [studio-operations](studio-operations/SKILL.md) | Studio Operations | Use when нужна оптимизация операций студии |
| 🎬 | [studio-producer](studio-producer/SKILL.md) | Studio Producer | Use when нужен портфельный продюсинг проектов |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| 🌍 | [anthropologist](anthropologist/SKILL.md) | Anthropologist | Use when проектирование культур и обществ |
| 📸 | [evidence-collector](evidence-collector/SKILL.md) | Evidence Collector | Use when нужна проверка приложения со скриншотами и фактами |
| 🧪 | [experiment-tracker](experiment-tracker/SKILL.md) | Experiment Tracker | Use when нужен дизайн, запуск и анализ A/B-экспериментов |
| 🖥️ | [gis-analyst](gis-analyst/SKILL.md) | Gis Analyst | Use when нужны карты, слои и запросы по геоданным |
| 📚 | [historian](historian/SKILL.md) | Historian | Use when нужна проверка истории: анахронизмы, детали эпохи |
| 💰 | [specialized-pricing-analyst](specialized-pricing-analyst/SKILL.md) | Specialized Pricing Analyst | Use when разработка стратегии ценообразования |
| 📊 | [statistician](statistician/SKILL.md) | Statistician | Use when pressure-testing claims or designing studies. |
| 🔍 | [threat-intelligence-analyst](threat-intelligence-analyst/SKILL.md) | Threat Intelligence Analyst | Use when нужна угроз-разведка и APT-профили |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| 📋 | [compliance-auditor](compliance-auditor/SKILL.md) | Compliance Auditor | Use when аудит соответствия SOC 2, ISO |
| ⚕️ | [healthcare-marketing-compliance](healthcare-marketing-compliance/SKILL.md) | Healthcare Marketing Compliance | Use when проверка медрекламы на соответствие закону |
| ⚖️ | [legal-compliance-checker](legal-compliance-checker/SKILL.md) | Legal Compliance Checker | Use when нужна проверка соответствия: законы, риски, санкции |
| 🛡️ | [specialized-fedramp-rmf-compliance](specialized-fedramp-rmf-compliance/SKILL.md) | Specialized Fedramp Rmf Compliance | Use when подготовка к FedRAMP или NIST RMF |
| 🗃️ | [zk-steward](zk-steward/SKILL.md) | Zk Steward | Use when база знаний, заметки Zettelkasten |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| 🏗️ | [bim-gis-specialist](bim-gis-specialist/SKILL.md) | Bim Gis Specialist | Use when интеграция BIM и ГИС |
...
| 🛸 | [drone-reality-mapping-specialist](drone-reality-mapping-specialist/SKILL.md) | Drone Reality Mapping Specialist | Use when нужна обработка снимков с дрона в геоданные |
| 🗄️ | [gaussdb-expert](gaussdb-expert/SKILL.md) | Gaussdb Expert | Use when проблемы производительности GaussDB OLTP |
| 🗺️ | [geographer](geographer/SKILL.md) | Geographer | Use when нужна проверка географии мира на правдоподобие |
| ⚙️ | [geoprocessing-specialist](geoprocessing-specialist/SKILL.md) | Geoprocessing Specialist | Use when нужна автоматизация обработки геоданных в ArcGIS |
| 🧠 | [psychologist](psychologist/SKILL.md) | Psychologist | Use when нужен психологический разбор персонажа |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| 🛒 | [china-ecommerce-operator](china-ecommerce-operator/SKILL.md) | China Ecommerce Operator | Use when операция магазина Taobao/PDD/JD |
| 🌏 | [cross-border-ecommerce](cross-border-ecommerce/SKILL.md) | Cross Border Ecommerce | Use when вывод товара на зарубежные маркетплейсы |
| 🇰🇷 | [korean-business-navigator](korean-business-navigator/SKILL.md) | Korean Business Navigator | Use when сделки и переговоры с корейским бизнесом |
...
| Emoji | Agent | Specialty | When to Use |
|-------|-------|-----------|-------------|
| 🩺 | [clinical-evidence-agent](clinical-evidence-agent/SKILL.md) | Clinical Evidence Agent | Use when клинические утверждения и источники |
...
| 🧡 | [healthcare-aging-parent-care-companion](healthcare-aging-parent-care-companion/SKILL.md) | Healthcare Aging Parent Care Companion | Use when координация ухода за пожилым родственником |
