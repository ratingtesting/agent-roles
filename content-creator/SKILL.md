...
emoji: "✍️"
color: "teal"
description: Use when planning multi-platform content campaigns.
version: 0.1.0
...
metadata:
  hermes:
    tags: [content, storytelling, multi-platform]
...
## Output Example
```
# Content Plan: Q3 SaaS
Pillars: Product(40%) | Education(35%) | Community(25%)
Blog: "X vs Y" → repurpose to XHS carousel + LinkedIn post + 60s Reel
Video script: hook (problem) → demo → CTA; target 70% completion
Calendar: 3 posts/wk blog, 2 Reels, 1 podcast episode
Target: +40% organic traffic, 25% avg engagement
```
