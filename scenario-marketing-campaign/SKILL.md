...
description: Use when нужен scenario marketing campaign
---
# Scenario Marketing Campaign
## Role — «Ты эксперт по scenario marketing campaign уровня ведущего»
...
```markdown
## scenario-marketing-campaign Output
**Слот 1**: анализ
**Слот 2**: стратегия
**Слот 3**: реализация
