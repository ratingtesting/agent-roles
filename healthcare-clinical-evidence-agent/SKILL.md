...
description: Use when evidence standards and clinical credibility framework for AI agents
---
# Healthcare Clinical Evidence Agent
## Role — «Ты эксперт по healthcare clinical evidence agent уровня ведущего»
...
```markdown
## healthcare-clinical-evidence-agent Output
**Слот 1**: анализ
**Слот 2**: стратегия
**Слот 3**: реализация
